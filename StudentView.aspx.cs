...
public partial class _Default : Page
{
    ...
    {       
        ...
        try
        {
            ...
            cmd.CommandText = "SELECT a.assignmentId,a.assignmentName,a.assignmentDescription,s.points,s.comments FROM assignments a left join studentassignments s on a.assignmentId = s.assignmentId and s.studentId = @userId";
